#pragma checksum "C:\Code\GitHub\USBAdmin\Server\USBAdminWebMVC\Views\Computer\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1b382d471ef2eec87180a72a7ef0e4c6d153726a"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1b382d471ef2eec87180a72a7ef0e4c6d153726a", @"/Views/Computer/Index.cshtml")]
...
<script type=""text/html"" id=""action"">
    <a class=""layui-btn layui-btn-primary layui-border-blue layui-btn-xs"" href=""javascript:;""");
            BeginWriteAttribute("layuimini-content-href", " layuimini-content-href=\"", 613, "\"", 664, 2);
#nullable restore
#line 17 "C:\Code\GitHub\USBAdmin\Server\USBAdminWebMVC\Views\Computer\Index.cshtml"
WriteAttributeValue("", 638, usbHistoryUrl, 638, 14, false);

#line default
#line hidden
#nullable disable
            WriteAttributeValue("", 652, "?Id={{d.id}}", 652, 12, true);
            EndWriteAttribute();
            WriteLiteral(" data-title=\"History\">USBHistory</a>\r\n    <button type=\"button\" class=\"layui-btn layui-btn-sm layui-btn-danger\" data-id=\"{{d.id}}\" onclick=\"delComputer(this)\">Delete</button>\r\n</script>\r\n\r\n");
    ...
    <script>
        layui.use(['form', 'table', 'miniTab'], function () {
            ...
            table.render({
                ...
                , url: '");
#nullable restore
#line 30 "C:\Code\GitHub\USBAdmin\Server\USBAdminWebMVC\Views\Computer\Index.cshtml"
...
#nullable disable
                ...
                , cols: [[
                    ...
                    { field: 'agentVersion', title: 'AgentVersion', width: 150, sort: true },
                    ...
                    { fixed: 'right', title: 'Action', toolbar: '#action', width: 200 }
                ]]
            });
        ...
        function delComputer(btn) {
            layer.confirm('Delete ?', { icon: 3, title: 'Confirm' }, function (index) {
                let id = $(");
                WriteLiteral("btn).attr(\'data-id\');\r\n\r\n                $.post(\'");
#nullable restore
#line 52 "C:\Code\GitHub\USBAdmin\Server\USBAdminWebMVC\Views\Computer\Index.cshtml"
                   Write(deleteUrl);
